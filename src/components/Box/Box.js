...
class Box extends React.Component {
  ...
  render() {
		const { beat, index, scoreBeat, timelineIndex, onPlayClick } = this.props;
    ...
    return (
          ...
          <div className={colorLineClass} style={{ background: colors[index] }} onMouseOut={() => this.lineOnMouseOut()} onMouseOver={() => this.props.showLineInfoAction()} />
